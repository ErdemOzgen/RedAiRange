            ...
            <div class="row first-row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="shadow-box big-padding">
                        <!-- <h4 class="mb-3">{{ $tc("redairangeAgent", 2) }} <span class="badge bg-warning" style="font-size: 12px;">beta</span></h4> -->
                        <h4 class="mb-3">{{ $tc("RedAiRange Agent Control Panel", 2) }} </h4>
                        ...
                        <form v-if="showAgentForm" @submit.prevent="addAgent">
                            <div class="mb-3">
                                <label for="url" class="form-label">{{ $t("redairangeURL") }}</label>
