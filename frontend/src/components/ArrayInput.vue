...
export default {
    ...
    computed: {
        ...
        service() {
            ...
            } else if (this.objectType === "x-redairange") {

                if (!this.$parent.$parent.jsonConfig["x-redairange"]) {
                    return {};
                }

                // Used in Compose.vue
                return this.$parent.$parent.jsonConfig["x-redairange"];
            } else {
                return {};
            }
        },
    ...
    methods: {
        addField() {
            ...
            if (this.objectType === "x-redairange") {
                if (!this.$parent.$parent.jsonConfig["x-redairange"]) {
                    this.$parent.$parent.jsonConfig["x-redairange"] = {};
                }
            }
