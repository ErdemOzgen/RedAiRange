        ...
        <transition name="slide-fade" appear>
            <div v-if="isEditMode && showConfig" class="config mt-3">
                ...
                <div class="mb-4">
                    ...
                    <!-- TODO: Search online: https://hub.docker.com/api/content/v1/products/search?q=erdemozgen%2Fuptime&source=community&page=1&page_size=4 -->
                    <datalist id="image-datalist">
                        <option value="erdemozgen/uptime-kuma:1" />
                    </datalist>
