    ...
    <div :class="classes">
        <div v-if="! $root.socketIO.connected && ! $root.socketIO.firstConnect" class="lost-connection">
            <div class="container-fluid">
                ...
                <div v-if="$root.socketIO.showReverseProxyGuide">
                    {{ $t("reverseProxyMsg1") }} <a href="https://github.com/ErdemOzgen/uptime-kuma/wiki/Reverse-Proxy" target="_blank">{{ $t("reverseProxyMsg2") }}</a>
                </div>
            </div>
        </div>
        ...
        <header v-if="! $root.isMobile" class="d-flex flex-wrap justify-content-center py-3 mb-3 border-bottom">
            <router-link to="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                ...
                <span class="fs-4 title">Red Ai Range</span>
            </router-link>

            <a v-if="hasNewVersion" target="_blank" href="https://github.com/ErdemOzgen/redairange/releases" class="btn btn-warning me-3">
            ...
            <ul class="nav nav-pills">
                <li v-if="$root.loggedIn" class="nav-item me-2">
                    <router-link to="/" class="nav-link">
                        ...
                        <span class="text-white">{{ $t("home") }}</span>
                ...
                <li v-if="$root.loggedIn" class="nav-item me-2">
                    <router-link to="/record" class="nav-link">
                        <font-awesome-icon icon="video" /> {{ $t("Record") }}
                    </router-link>
                </li>
