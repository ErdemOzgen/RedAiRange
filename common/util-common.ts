...
export const ALL_ENDPOINTS = "##ALL_REDAIRANGE_ENDPOINTS##";
...
export function statusColor(status : number) : string {
    switch (status) {
        ...
        case CREATED_STACK:
            return "dark";
        case RUNNING:
            return "primary"; // TODO: We need to come up new color for this and running ones
        case EXITED:
            return "danger";
        default:
            return "secondary";
...
// TODO: WE DONT NEED TO CONTROL THIS FOR CYBER RANGE
...
// TODO: Not working control D in python
