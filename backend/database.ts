...
export class Database {
    /**
     * SQLite file path (Default: ./data/redairange.db)
     * @type {string}
     */
    ...
    private static server : RedAiRangeServer;
    ...
    static async init(server : RedAiRangeServer) {
        this.server = server;
    ...
    static async connect(autoloadModels = true) {
        ...
        if (dbConfig.type === "sqlite") {
            this.sqlitePath = path.join(this.server.config.dataDir, "redairange.db");
        ...
        try {
            ...
            if (e instanceof Error) {
                ...
                if (e.message.includes("the following files are missing:")) {
                    ...
                    log.warn("db", "Database migration failed, you may be downgrading redairange.");
                } else {
