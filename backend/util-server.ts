...
export interface RedAiRangeSocket extends Socket {
    userID: number;
...
export function checkLogin(socket : RedAiRangeSocket) {
    if (!socket.userID) {
...
export async function doubleCheckPassword(socket : RedAiRangeSocket, currentPassword : unknown) {
