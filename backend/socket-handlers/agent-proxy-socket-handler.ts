...
import { log } from "../log";
import { checkLogin, RedAiRangeSocket } from "../util-server";
import { AgentSocket } from "../../common/agent-socket";
import { ALL_ENDPOINTS } from "../../common/util-common";

export class AgentProxySocketHandler extends SocketHandler {

    create2(socket : RedAiRangeSocket, server : RedAiRangeServer, agentSocket : AgentSocket) {
    ...
    create(socket : RedAiRangeSocket, server : RedAiRangeServer) {
